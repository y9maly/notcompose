import { mutableStateOf } from '@notcompose/core'
import type { HistoryData } from '../components/plot/HistoryData.js'
import type { SystemInfoRepository } from '../repository/SystemInfoRepository.js'
