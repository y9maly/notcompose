import { DisposableEffect, Key, remember, rememberState } from '@notcompose/core'
        ...
        Box(() => {
            Key(activeScreen, () => {
                ...
                if (activeScreen === 'RawInfo') {
                    ...
                    RawInfoScreen(viewModel, Modifier.fillMaxSize())
                }
            })
        }, Modifier
